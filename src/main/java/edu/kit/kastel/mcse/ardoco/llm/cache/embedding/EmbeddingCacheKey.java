...
public final class EmbeddingCacheKey implements CacheKey {
     ...
     */
    private EmbeddingCacheKey(String model, int seed, double temperature, LargeLanguageModelCacheMode mode, String content, String localKey) {
        this.model = model;
        this.seed = seed;
    ...
    static EmbeddingCacheKey of(EmbeddingCacheParameter cacheParameter, String content) {
        return new EmbeddingCacheKey(cacheParameter.modelName(), -1, -1, LargeLanguageModelCacheMode.EMBEDDING, content, KeyGenerator.generateKey(content));
    }
    ...
    public String toString() {
        return "EmbeddingCacheKey[" + "model=" + model + ", " + "seed=" + seed + ", " + "temperature=" + temperature + ", " + "mode=" + mode + ", " + "content=" + content + ", " + "localKey=" + localKey + ']';
    }
}
